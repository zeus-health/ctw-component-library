...
export const QUERY_KEY_OTHER_PROVIDER_DIAGNOSTIC_REPORTS = "other_provider_diagnostic_reports";
...
export const queryKeyPatientsList = (builderID: string) => `patients_list_${builderID}`; // Unique query key for each builder
