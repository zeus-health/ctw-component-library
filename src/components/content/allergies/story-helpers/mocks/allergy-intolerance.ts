...
export const allergyIntolerance: Bundle<AllergyIntolerance> = {
  ...
  entry: [ {
    fullUrl: "https://api.sandbox.zusapi.com/fhir/AllergyIntolerance/5d185eaa-fa1d-43d3-a0e8-aa9544c7d140",
    resource: {
    ...
    fullUrl: "https://api.sandbox.zusapi.com/fhir/AllergyIntolerance/8802e234-0ec6-4af2-9322-b2f402521c60",
    resource: {
      resourceType: "AllergyIntolerance",
      id: "8802e234",
      meta: {
    ...
    fullUrl: "https://api.sandbox.zusapi.com/fhir/AllergyIntolerance/54eaab33-a632-414d-9d92-908065b1db20",
    resource: {
      resourceType: "AllergyIntolerance",
      id: "54eaab33",
      meta: {
