import{e as M,j as E,w as A,n as b,K as y}from"./iframe.a21b86a2.js";var c="backgrounds",{document:s,window:L}=A,B=()=>L.matchMedia("(prefers-reduced-motion: reduce)").matches,H=(r,e=[],t)=>{if(r==="transparent")return"transparent";if(e.find(a=>a.value===r))return r;let n=e.find(a=>a.name===t);if(n)return n.value;if(t){let a=e.map(o=>o.name).join(", ");M.warn(E`
...
//# sourceMappingURL=preview.d7ad8b71.js.map
