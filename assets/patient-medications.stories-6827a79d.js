import{R}from"./index-6f814c40.js";import{w as n,b as u,u as c,e as d}from"./index-10f7dd35.js";import{s as q,p as D,o as I}from"./requests-dcad5c76.js";import{aq as E,C as U,a as W,S as z}from"./patient-allergies-aa67b24b.js";import"./_commonjsHelpers-042e6b4d.js";import"./isEqual-298b6ab1.js";import"./_baseIsEqual-7d59e24c.js";import"./_equalByTag-eda72788.js";import"./uniq-8676ca12.js";import"./_createSet-6ff8e1d4.js";import"./index-a6c8ef6f.js";import"./index-356e4a49.js";import"./action-list-bc3500ad.js";import"./index-74f03c09.js";import"./sortBy-a390368e.js";import"./_baseForOwn-7324d3a8.js";import"./_baseToString-7c0e3f59.js";import"./_baseClone-17ec433b.js";import"./toNumber-d7ce3bd9.js";import"./isPlainObject-f51be120.js";import"./_basePickBy-fa3aec3b.js";import"./mapValues-13598fe6.js";import"./request-5d5ec5f4.js";import"./table-cb4e25ad.js";import"./isString-933c0e0c.js";import"./spinner-66aa4ba7.js";import"./_commonjs-dynamic-modules-302442b1.js";import"./data-list-254aa0b0.js";import"./drawer-3c02213f.js";import"./index-6de6b113.js";import"./extends-b0154772.js";import"./debounce-5029c56d.js";async function y(o){const e=n(o),a=await u(()=>n(e.getByRole("dialog")));return{search:t=>c.type(a.getByPlaceholderText("Type to search"),t),selectMedication:async t=>c.click(await a.findByRole("option",{name:t})),status:t=>c.selectOptions(a.getByTestId("form-field-status"),t),instructions:t=>c.type(a.getByLabelText("Instructions"),t),cancel:()=>c.click(a.getByRole("button",{name:"Cancel"})),save:async()=>{c.click(a.getByRole("button",{name:"Save"}))}}}async function v(o){const e=n(o);await u(()=>d(e.queryAllByRole("table")).toHaveLength(2));const a=e.queryAllByRole("table"),t=M(o,a[0]),i=M(o,a[1]);return{patientRecord:t,otherProvider:i,clickAddMedication:()=>c.click(e.getByRole("button",{name:"+ Add Medication"}))}}function M(o,e){async function a(i,r){c.hover(t(i)),c.click(n(t(i)).getByTestId(r))}function t(i){const r=n(e).getAllByRole("rowgroup")[1];return n(r).queryAllByRole("row")[i]}return{table:n(e),toHaveRowCount:async i=>{i===0?await u(()=>{const r=n(e).getAllByRole("rowgroup")[1];d(r).toBeFalsy()}):await u(()=>{const r=n(e).getAllByRole("rowgroup")[1];d(n(r).queryAllByRole("row")).toHaveLength(i)})},toHaveRowWithText:(i,r)=>n(t(i)).getByText(r),toHaveAnyRowWithText:async i=>{const r=await n(e).getAllByRole("rowgroup")[1];d(n(r).getAllByRole("row").some(S=>!!n(S).queryByText(i))).toBeTruthy()},addToRecord:i=>a(i,"add-to-record")}}const he={tags:["autodocs"],component:E,decorators:[(o,{args:e})=>R.createElement(U,{env:"dev",authToken:"ey.12345",builderId:"12345"},R.createElement(W,{patientID:"007",systemURL:z},R.createElement(o,{args:e})))]},s={...q({providerMedications:D,otherProviderMedications:I})},m={...s,args:{hideAddToRecord:!0}},l={...s,play:async({canvasElement:o})=>{const e=await v(o);await e.patientRecord.toHaveRowCount(1);const a="albendazole 200 MG Oral Tablet [Albenza]";e.clickAddMedication();const t=await y(o);t.search("alb"),await t.selectMedication(a),t.status("Active"),t.instructions("Take 2.3 every 3.14 hours, if dose is missed spin around 4.5 times"),await t.save(),await e.patientRecord.toHaveRowCount(2),d(await e.patientRecord.table.findByText(a)).toBeTruthy()}},p={...s,play:async({canvasElement:o})=>{const e=await v(o);await e.patientRecord.toHaveRowCount(1),await e.otherProvider.toHaveRowCount(4);const a="3 ML insulin aspart protamine, human 70 UNT/ML / insulin aspart, human 30 UNT/ML Pen Injector [NovoLog Mix]";e.otherProvider.toHaveRowWithText(0,a),await e.otherProvider.addToRecord(0),await(await y(o)).save(),await e.patientRecord.toHaveRowCount(2),await e.otherProvider.toHaveRowCount(3),await e.patientRecord.toHaveAnyRowWithText(a)}},w={...s,play:async({canvasElement:o})=>{const e=await v(o);await e.patientRecord.toHaveRowCount(1);const a="cabozantinib 20 MG Oral Capsule [Cometriq]";e.clickAddMedication();const t=await y(o);t.search("cab"),await t.selectMedication(a),t.status("Active"),t.cancel(),await e.patientRecord.toHaveRowCount(1),d(e.patientRecord.table.queryByText(a)).toBeFalsy()}};var T,h,B;s.parameters={...s.parameters,docs:{...(T=s.parameters)==null?void 0:T.docs,source:{originalSource:`{
...
//# sourceMappingURL=patient-medications.stories-6827a79d.js.map
