import{s as M}from"./index.e850844b.js";import{d as v}from"./index.67736049.js";var p="backgrounds",{document:s,window:k}=M,B=()=>k.matchMedia("(prefers-reduced-motion: reduce)").matches,S=(r,e=[],d)=>{if(r==="transparent")return"transparent";if(e.find(a=>a.value===r))return r;let t=e.find(a=>a.name===d);if(t)return t.value;if(d){let a=e.map(i=>i.name).join(", ");__STORYBOOK_MODULE_CLIENT_LOGGER__.logger.warn(v`
    ...
    `},[o]);return __STORYBOOK_MODULE_PREVIEW_API__.useEffect(()=>{let m=e.viewMode==="docs"?`addon-backgrounds-grid-docs-${e.id}`:"addon-backgrounds-grid";if(!i){y(m);return}h(m,f)},[i,f,e]),r()},P=[x,R],w={[p]:{grid:{cellSize:20,opacity:.5,cellAmount:5},values:[{name:"light",value:"#F8F8F8"},{name:"dark",value:"#333333"}]}},Y={[p]:null};export{P as decorators,Y as globals,w as parameters};
//# sourceMappingURL=preview.87892617.js.map
